...
class SortableTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sortable = new Sortable('http://examen/demo');
    }
    /** @test */
    ...
    {
        $this->assertSame(
            'http://examen/demo?order=first_name',
    ...
    function builds_a_url_with_desc_order_if_the_current_column_matches_the_given_one_and_the_current_direction_is_asc()
    {
        ...
        $this->assertSame(
            'http://examen/demo?order=first_name-desc',
    ...
    function appends_query_data_to_the_url()
    {
        ...
        $this->assertSame(
            'http://examen/demo?a=parameter&and=another-parameter&order=first_name',
            $this->sortable->url('first_name')
        );
    }
